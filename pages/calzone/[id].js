...
const Calzone = () => {
  const [calzoneFinal, setCalzoneFinal] = useState({});
  ...
  const products = useSelector((state) => state.products["calzones"]);

  const calzone = products.find((product) => product.id == id);

  useEffect(() => {
    if (calzone) {
      setCalzoneFinal(calzone);
      setPrice(calzone.precio);
      setTamaño(calzone.tamaño);
      SetCantidad(calzone.cantidad + 1);
      calzone.ingredientes.others.forEach((ingrediente) => {
  ...
  return (
    <>
      <Layout>
        {/* <!-- Subheader Start --> */}
        <Subheader pagina="Arma tu Calzone" />
        {/* <!-- Subheader End --> */}
            ...
            <div className="row">
              <div className="col-md-5">
                ...
                <div className="product-thumb">
                  <img
                    src={`../assets/img/productos/calzone.png`}
                    alt="calzone"
                  />
                </div>
                {/* <!-- /Main Thumb --> */}
              ...
              <div className="col-md-7">
                <div className="product-content">
                  ...
                  <h2 className="title">
                    {calzone
                      ? `${
                          calzone.categoria[0].toUpperCase() +
                          calzone.categoria.slice(1)
                        } de ${calzone.nombre}`
                      : "Personalizada"}
                  </h2>
                  {/* <!-- /Product Title --> */}
                  ...
                  <div className="price-wrapper">
                    <p className="product-price">{calzone ? price : 10.99}$</p>
                  </div>
                  {/* <!-- /Price --> */}
